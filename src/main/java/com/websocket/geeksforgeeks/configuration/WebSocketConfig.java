...
//This is configuration and thus all web socket connections will be handled by this class
@Configuration
@EnableWebSocket
public class WebSocketConfig implements WebSocketConfigurer {
    ...
    public void registerWebSocketHandlers(WebSocketHandlerRegistry webSocketHandlerRegistry) {
		//For adding a Handler we give the Handler class we created before with End point 
		//Also we are managing the CORS policy for the handlers so that other domains can also access the socket
